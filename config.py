...
# node reconnection behaviour
NODE_RECONNECT_ATTEMPTS = config("NODE_RECONNECT_ATTEMPTS", cast=int, default=5)
NODE_RECONNECT_BACKOFF = config("NODE_RECONNECT_BACKOFF", cast=int, default=2)
