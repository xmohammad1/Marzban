...
NODE_API_TIMEOUT = config("NODE_API_TIMEOUT", cast=int, default=10)
NODE_API_RETRIES = config("NODE_API_RETRIES", cast=int, default=5)
NODE_HEALTH_TIMEOUT = config("NODE_HEALTH_TIMEOUT", cast=int, default=5)
