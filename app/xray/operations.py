...
def _add_user_to_inbound(api: XRayAPI, inbound_tag: str, account: Account):
    ...
    except (xray.exc.EmailExistsError, xray.exc.ConnectionError, xray.exc.TimeoutError, ConnectionError):
        pass
...
def _remove_user_from_inbound(api: XRayAPI, inbound_tag: str, email: str):
    ...
    except (xray.exc.EmailNotFoundError, xray.exc.ConnectionError, xray.exc.TimeoutError, ConnectionError):
        pass
